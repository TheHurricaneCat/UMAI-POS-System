...
function KeyPadContainer({addNewTray, currentTotal, appendEntry, tray}) {
    return (
        <>
            <div className={styles.primaryContainer}>
                ...
                <div className={styles.saveOrder}> <button onClick={() => appendEntry('/public/TestFIle.xlsx', tray)}> Save Order </button> </div>
                <div className={styles.clearOrder}> <button> Clear Order </button> </div>
                <div className={styles.clearTray}> <button> Clear Tray </button> </div>
            </div>
        </>
    );
}
