        ...
        <>
            <div className={styles.primaryContainer}>
                        ...
                        <div className={styles.customerSection}>
                            {content.customer ? (
                                <div className={styles.customerInfo}>
                                    <span>{(content.customer.customerName === "-") ? "" : content.customer.customerName} </span>
                                    <button 
                ...
                <div className={styles.trayContainer}> 
                    {!isSelected && content.products && content.products.length > 0 && (
                        <div className={styles.primaryNonFocused}></div>
                    )}
